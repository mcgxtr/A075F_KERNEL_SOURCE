...
1. How to Build
   ...
   - Set Build Environment and Export Target Config
      ...
      $ python kernel_device_modules-6.12/scripts/gen_build_config.py
                                            ...
                                            --kernel-defconfig-overlays "sec_ogki_fragment.config entry_level.config hs07.config mt6789_teegris_4_overlay.config"
                                            --kernel-build-config-overlays ""
                                            -m user -o ../out/target/product/a07/obj/KERNEL_OBJ/build.config
...
2. Output Files
   - Kernel : out/target/product/a07/obj/KLEAF_OBJ/dist/kernel_device_modules-6.12/mgk_64_k612_kernel_aarch64.user/Image.gz
   - Module : out/target/product/a07/obj/KLEAF_OBJ/dist/*/*.ko
############################################################################################################################################
