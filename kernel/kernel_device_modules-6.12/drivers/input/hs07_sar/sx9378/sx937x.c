...
/*hs07 code for HS07-1221 by liuyiying at 20250421 start*/
...
/*hs07 code for HS07-1221 by liuyiying at 20250421 end*/
...
//=================================================================================================
//ANFR
/* hs07 code for SR-AL7761A-01-132 | SR-AL7761A-01-120 by huofudong at 20250320 start */
#ifdef SX937X_USER_NODE
static void smtc_anfr_irq(Self self)
{
    ...
    if (((prox_state >> 25) & 1) != gs_last_state) {
        g_irq_count++;
        gs_last_state = (prox_state >> 25) & 1;
...
/*Tab A11 code for AX7800A-612 by lichang at 20240424 start*/
/* hs07 code for P250910-01527|P250910-01309 by wangtegfei at 20250915 start*/
static ssize_t smtc_set_dumpinfo(const char *buf, size_t count)
{
    ...
    /* hs07 code for P250910-01527|P250910-01309 by wangtegfei at 20250915 end*/
    /* hs07 code for SR-AL7761A-01-134 | SR-AL7761A-01-124 by huofudong at 20250320 start */
    /*hs07 code for HS07-1221 by liuyiying at 20250421 start*/
    if (value == GRIP_MAIN) {
        g_channel = CH2;
    ...
    /*hs07 code for HS07-1221 by liuyiying at 20250421 end*/
    /* hs07 code for SR-AL7761A-01-134 | SR-AL7761A-01-124 by huofudong at 20250320 end */
...
static ssize_t smtc_get_dumpinfo(char *buf)
{
    ...
    if (g_self != NULL) {
        ...
        /*hs07 code for HS07-1221 by liuyiying at 20250421 start*/
        /*hs07 code for HS07-2880 by huofudong at 20250512 start*/
        if (g_channel == CH2) {
            shift = CH3 * g_bitoffset;
            smtc_i2c_read(g_self, REG_PH0_OFFSET + shift * OFFSET_PH_REG_SHIFT, &reg_val);
            g_dumpinfo.ref_cap = (u16)(reg_val & OFFSET_VAL_MASK);
        }
        else if(g_channel == CH0) {
