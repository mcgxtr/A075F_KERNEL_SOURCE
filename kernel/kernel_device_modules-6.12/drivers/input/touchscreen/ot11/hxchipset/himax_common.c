        ...
        size_t len, loff_t *pos)
{
    ...
    if (copy_from_user(buf, buff, len))
        return -EFAULT;
/*Tab A9 code for AX6739W-46 by xiongwei at 20250612 start*/
    if (buf[0] == '0') {
        ts->SMWP_enable = 0;
    } else if (buf[0] == '1') {
        ts->SMWP_enable = 1;
...
/*Tab A9 code for AX6739W-46 by xiongwei at 20250612 end*/
...
/*Tab A9 code for AX6739W-46 by xiongwei at 20250630 start*/
...
/*Tab A9 code for AX6739W-46 by xiongwei at 20250630 end*/
