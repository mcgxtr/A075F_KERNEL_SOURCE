...
/*Tab A9 code for AX6739W-46 by xiongwei at 20250819 start*/
#define SET_PWR_MODE_RETRY_TIME         3
#define SET_PWR_MODE_RETRY_DELAY        5
/*Tab A9 code for AX6739W-46 by xiongwei at 20250819 end*/
...
/*Tab A9 code for P250915-07651 by xiongwei at 20250922 start*/
#ifdef CFG_CTS_GESTURE
    if (unlikely(cts_dev->rtdata.suspended)) {
        if (cts_dev->rtdata.gesture_wakeup_enabled) {
            __pm_wakeup_event(g_cts_data->ws, 5000);
            mdelay(20);
        }
    }
#endif
/*Tab A9 code for P250915-07651 by xiongwei at 20250922 end*/
