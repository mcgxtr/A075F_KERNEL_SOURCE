...
static int jadard_parse_sorting_threshold_file(void)
{
    ...
    char *file_name = pjadard_ts_data->jd_csv_name;
...
static int jadard_sorting_test(void)
{
    ...
    uint32_t fw_ret = 0;
    /*Tab A11 code for AX7800W-11 by tangchuanjing at 20250811 start*/
    char *fileName = pjadard_ts_data->jd_fw_rq_name;
    /*Tab A11 code for AX7800W-11 by tangchuanjing at 20250811 end*/
    ...
    if ((ret != 0) || (Soc_Debug_Number >= 6)) {
        ret = 1;
    }
    /*Tab A11 code for AX7800W-11 by tangchuanjing at 20250811 start*/
    scnprintf(jd_g_file_path, JD_RSLT_OUT_FILE_SIZE, "%s%s_%s_%s.txt",
         JD_RSLT_OUT_PATH, ret == 0 ? "PASS" : "FAIL", pjadard_ts_data->module_name, get_date_time_str());
    /*Tab A11 code for AX7800W-11 by tangchuanjing at 20250811 end*/
...
#ifdef JD_UPGRADE_ITO_FW
    /*Tab A11 code for AX7800W-11 by tangchuanjing at 20250811 start*/
    fileName = pjadard_ts_data->jd_fw_rq_name;
    /*Tab A11 code for AX7800W-11 by tangchuanjing at 20250811 end*/
    JD_I("%s: Bin file name(%s)\n", __func__, fileName);
