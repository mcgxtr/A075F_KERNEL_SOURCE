...
extern bool g_int_pin_test_value;
#define CTS_INT_DEFAULT_TEST_VAL true
...
struct cts_platform_data {
    ...
    u8 spi_cache_buf[ALIGN(CFG_CTS_MAX_SPI_XFER_SIZE + 20, 4)];
    u8 spi_rx_buf[ALIGN(CFG_CTS_MAX_SPI_XFER_SIZE + 20, 4)];
    u8 spi_tx_buf[ALIGN(CFG_CTS_MAX_SPI_XFER_SIZE + 20, 4)];
    u32 spi_speed;
#endif
};
...
extern int cts_switch_to_test_irq(struct cts_platform_data *pdata);
/*HS07 code for SR-AL7761A-01-259 by guyuming at 20250317 start*/
extern int restore_normal_irq(struct cts_platform_data *pdata);
/*HS07 code for SR-AL7761A-01-259 by guyuming at 20250317 end*/
