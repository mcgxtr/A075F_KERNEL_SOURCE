...
/*HS07 code for SR-AL7761A-01-259 by guyuming at 20250317 start*/
...
/*HS07 code for SR-AL7761A-01-259 by guyuming at 20250317 end*/
        ...
        struct cts_device_touch_msg *msgs, int num)
{
    ...
    /*HS07 code for SR-AL7761A-01-268 by guyuming at 20250325 start*/
    if (!get_tp_enable()) {
        cts_info("Touch function is disabled. Ignoring all touch events.");
        return 0;
    }
    /*HS07 code for SR-AL7761A-01-268 by guyuming at 20250325 end*/
    ...
    for (i = 0; i < num; i++) {
        ...
        /*HS07 code for SR-AL7761A-01-258 by guyuming at 20250320 start*/
        ...
        /*HS07 code for SR-AL7761A-01-258 by guyuming at 20250320 end*/
...
int cts_plat_init_gesture(struct cts_platform_data *pdata)
{
    ...
    input_set_capability(pdata->ts_input_dev, EV_KEY, pdata->gesture_keymap[3][1]);
