...
/*HS07 code for HS07-4936 by guyuming at 20250707 start*/
/*HS07 code for HS07-2980 by guyuming at 20250515 start*/
/*HS07 code for AL7761C-1303 by xiongwei at 20250930 start*/
static int chipone_get_tp_module(void)
{
    ...
    } else if (NULL != strstr(panel_name, "nl9916x_txd_boe_htr")) {
        fw_num = MODEL_TXD_BOE_HTR;
    } else {
...
static void chipone_update_module_info(void)
{
    ...
    switch (module) {
        ...
        case MODEL_TXD_BOE_HH:
            ...
            break;
        case MODEL_TXD_BOE_HTR:
            strcpy(cts_data->module_name,"nl9916x_txd_boe_htr");
            strcpy(cts_data->cts_firmware_filename, "nl9916x_txd_boe_htr_firmware.bin");
            break;
        default:
...
/*HS07 code for AL7761C-1303 by xiongwei at 20250930 end*/
/*HS07 code for HS07-4936 by guyuming at 20250707 end*/
