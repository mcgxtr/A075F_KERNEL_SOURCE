...
#define GGCORE_FLASHDOWNLOAD_SIZE           (1*1024)
#define GCORE_FLASH_DATA_SIZE               (65536)
#define GCORE_LENFTH_OF_FLASH_READ_ONCE     (56)
#define GCORE_READ_FLASH_LOOP_TIMES         (GCORE_FLASH_DATA_SIZE / GCORE_LENFTH_OF_FLASH_READ_ONCE)
#define GCORE_READ_FLASH_BUFF_LEN           (GCORE_LENFTH_OF_FLASH_READ_ONCE + 8)
extern struct completion flashdata_complete;
#endif
...
enum fw_event_type {
    ...
    FW_NFC_ENABLE,
    FW_NFC_DISABLE,
    FW_GESTURE_SUCCESS_NOTIFY,
    FW_GESTURE_SUCCESS_NOTIFY_CLEAR,
    FW_EDGE_270,
    FW_EDGE_270_DISABLE,
    FW_GESTURE_REPORT_INT,
    FW_GESTURE_REPORT_INT_CLEAR,
};
enum notify_event_type{
    NOTIFY_FW_EDGE_90 = 1,
    NOTIFY_FW_EDGE_0 = 2,
    NOTIFY_FW_CHARGER_PLUG = 3,
    NOTIFY_FW_CHARGER_UNPLUG = 4,
    NOTIFY_FW_HEADSET_PLUG = 5,
    NOTIFY_FW_HEADSET_UNPLUG = 6,
    NOTIFY_FW_GESTURE_ENABLE = 7,
    NOTIFY_FW_GESTURE_DISABLE = 8,
    NOTIFY_FW_GLOVE_ENABLE = 9,
    NOTIFY_FW_GLOVE_DISABLE = 10,
    NOTIFY_FW_REPORT_RATE_180 = 11,
    NOTIFY_FW_REPORT_RATE_120 = 12,
    NOTIFY_FW_REPORT_HIGH_SENSITIVITY = 13,
    NOTIFY_FW_REPORT_NORMAL_SENSITIVITY = 14,
    NOTIFY_FW_EDGE_270_ENABLE = 15,
    NOTIFY_FW_EDGE_270_DISABLE = 16,

    NOTIFY_FW_TEL_CALL = 17,
    NOTIFY_FW_TEL_HANDUP = 18,
    NOTIFY_FW_HANDSFREE_ON = 19,
    NOTIFY_FW_HANDSFREE_OFF = 20,

    NOTIFY_FW_NFC_ENABLE = 33,
    NOTIFY_FW_NFC_DISABLE = 34,

    NOTIFY_FW_GESTURE_REPORT_INT = 41,
    NOTIFY_FW_GESTURE_REPORT_INT_CLEAR = 42,

    NOTIFY_FW_GESTURE_SUCCESS_NOTIFY = 47,
    NOTIFY_FW_GESTURE_SUCCESS_NOTIFY_CLEAR = 48,

    NOTIFY_PROXIMITY_NEAR = 50,
    NOTIFY_PROXIMITY_AWAY = 51,
};
...
#ifdef CONFIG_GET_DATA_FROM_FLASH
extern int gcore_read_flash_data_proc(void);
extern void gcore_set_flashread_parameters(u32 len,u32 addr);
#endif
