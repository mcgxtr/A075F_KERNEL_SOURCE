...
/*------------------------------------------------------------------*/
#define TOUCH_DRIVER_RELEASE_VERISON   ("1.6.1.3_250303")
 ...
 */
#define CONFIG_TOUCH_DRIVER_RUN_ON_MTK_PLATFORM_SETTING 
...
#ifdef CONFIG_TOUCH_DRIVER_RUN_ON_MTK_PLATFORM_SETTING
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0))
#define CONFIG_TOUCH_DRIVER_RUN_ON_QCOM_PLATFORM // mtk kernel > 5.04 , use qcom platform, not use ptd.
#else
...
/*
 * Note.
 * The below compile option is used to enable Flash Read Flow
 */
#ifdef CONFIG_GCORE_AUTO_UPDATE_FW_FLASHDOWNLOAD
#define CONFIG_GET_DATA_FROM_FLASH
#endif
 ...
 */
#if 1//GCORE_MP_TEST_ON
#define MP_TEST_INI     "gcore_mp_test.ini"
#define MP_BIN_NAME     "gcore_mp.bin"
#endif
