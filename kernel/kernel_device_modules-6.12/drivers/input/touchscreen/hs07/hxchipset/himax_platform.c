...
/*HS07 code for HS07-2937 by huangyin at 20250513 start*/
        ...
        if (ts->SMWP_enable) {
            if ( hx_s_ts->IRQ_WAKEUP_STA == 1 ) {
                irq_set_irq_wake(ts->hx_irq, 0);
                hx_s_ts->IRQ_WAKEUP_STA = 0;
            }
        }
#endif
 ...
 */
/*HS07 code for HS07-2384 by huangyin at 20250427 start*/
        ...
        unsigned long value, void *v)
{
    ...
    if (ts && v) {
        if (value == MTK_DISP_EARLY_EVENT_BLANK || value == MTK_DISP_ESD_RECOVERY_RESUME ||
            value == MTK_DISP_ESD_RECOVERY_SUSPEND) {
...
/*HS07 code for HS07-2384 by huangyin at 20250427 end*/
#endif
...
static int __init himax_common_init(void)
{
    ...
    /*HS07 code for SR-AL7761A-01-549 by huangyin at 20250318 start*/
    if (tp_detect_panel("hx83108d") == 0) {
        spi_register_driver(&himax_common_driver);
    } else {
        return -EFAULT;
    }
    /*HS07 code for SR-AL7761A-01-549 by huangyin at 20250318 end*/
