...
#define HIMAX_DRIVER_VER "3.0.0.36_HS07_08"
...
#define CONFIG_TOUCHSCREEN_HIMAX_IC_HX83108D
...
/*HS07 code for HS07-218 by huangyin at 20250331 start*/
#define HX_RETRY_SELF_TEST
/*HS07 code for HS07-218 by huangyin at 20250331 end*/
...
#define BOOT_UPGRADE_FWNAME "hx83108d_xx_hkc_firmware.bin"
#if defined(HX_ZERO_FLASH)
extern uint8_t *g_update_cfg_buf;
#define MPAP_FWNAME "hx83108d_xx_hkc_mpfw.bin"
...
#if defined(HX_SMART_WAKEUP)
/*HS07 code for SR-AL7761A-01-245 by huangyin at 20250317 start*/
...
/******* SPI-end *******/
    ...
    char himax_nomalfw_rq_name[HIMAX_FW_NAME_LEN];
    char himax_mpfw_rq_name[HIMAX_FW_NAME_LEN];
    char himax_csv_name[HIMAX_FW_NAME_LEN];
    char module_name[HIMAX_FW_NAME_LEN];
