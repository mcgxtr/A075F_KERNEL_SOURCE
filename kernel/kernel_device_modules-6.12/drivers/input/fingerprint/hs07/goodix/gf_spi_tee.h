...
struct gf_device {
	...
	struct pinctrl_state *pins_miso_spi, *pins_miso_pullhigh,
		*pins_miso_pulllow;
	struct pinctrl_state *pins_reset_high, *pins_reset_low, *pins_vdd_high,
		*pins_vdd_low;
	struct pinctrl_state *pinstate_gpio_func, *pinstate_spi_func;
	/*HS07 code for SR-AL7761A-01-184 by hehaoran at 20250325 start */
	struct pinctrl_state *pinstate_irq_to_gpio;
