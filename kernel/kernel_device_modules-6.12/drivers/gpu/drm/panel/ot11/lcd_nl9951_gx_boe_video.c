...
/*Tab A9 code for AX6739W-45 by jiangyue at 20250612 start*/
extern bool g_smart_wakeup_flag;
/*Tab A9 code for AX6739W-45 by jiangyue at 20250612 end*/
...
static int lcm_prepare(struct drm_panel *panel)
{
    ...
    mdelay(10);
    gpiod_set_value(ctx->reset_gpio, 0);
    /*Tab A9 code for AX6739W-45 by jiangyue at 20250618 start*/
    mdelay(2);
    gpiod_set_value(ctx->reset_gpio, 1);
    devm_gpiod_put(ctx->dev, ctx->reset_gpio);
    mdelay(25);
    /*Tab A9 code for AX6739W-45 by jiangyue at 20250618 end*/
