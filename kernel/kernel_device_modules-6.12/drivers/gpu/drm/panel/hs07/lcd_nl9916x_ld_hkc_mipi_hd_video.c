...
{
    //V03 Follow module gamma setting
    lcm_dcs_write_seq_static(ctx, 0xF0,0x99,0x16,0x18);
    lcm_dcs_write_seq_static(ctx, 0xB2,0x11,0x11,0x10,0x10,0x66,0x66,0x0B,0x03,0x88,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x00,0x00,0x55,0x55,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0xB3,0xF7,0x49,0x09,0x6A,0x00,0x6A,0x05);//DUTY=43.7%
    lcm_dcs_write_seq_static(ctx, 0xB4,0x01,0x0B,0x06,0x16,0x13);
    lcm_dcs_write_seq_static(ctx, 0xB6,0x00,0x00,0x00,0xBB,0xBB,0x00,0x00,0x00,0xBB,0xBB,0x10,0x12,0x14,0x16,0x18,0x1A,0x1C,0x1E,0x06,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFC);
    lcm_dcs_write_seq_static(ctx, 0xB5,0x00,0x00,0x00,0xBB,0xBB,0x00,0x00,0x00,0xBB,0xBB,0x11,0x13,0x15,0x17,0x19,0x1B,0x1D,0x1F,0x07,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFC);
    lcm_dcs_write_seq_static(ctx, 0xB7,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55);
    lcm_dcs_write_seq_static(ctx, 0xB8,0x00,0x00,0x00,0xF0,0xF0,0x00,0x00,0x00,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0xBB,0x01,0x02,0x03,0x0A,0x04,0x13,0x14,0x12);
    lcm_dcs_write_seq_static(ctx, 0xBC,0xFF,0xF0,0x05,0x00,0x00,0x00,0x00,0x04,0x00,0x05,0x08,0xBB,0x08,0x5B,0x66,0x66,0x60,0x64,0x3C,0x5E,0x36);////VGH=16VVGL=-12VVGHO=15VVGLO=-11V
    ...
    lcm_dcs_write_seq_static(ctx, 0xC5,0x00,0x17,0x1A,0x00,0xFF,0x08,0xF0,0x20,0x20,0x00);
    lcm_dcs_write_seq_static(ctx, 0xC8,0x44,0x00,0x88,0xA3);
    lcm_dcs_write_seq_static(ctx, 0xCA,0x09,0x40,0x01,0x19,0x46,0x94,0x41,0x8F,0x22,0x33,0x5E,0x5E,0x36,0x4A,0x64,0x64,0x3C,0x50,0x11,0x00,0x01,0x01,0x0A,0x06,0x02,0x02,0x05,0x00,0x00,0x04);
    lcm_dcs_write_seq_static(ctx, 0xCC,0x00);
    //GAMMA2.2
    lcm_dcs_write_seq_static(ctx, 0xC7,0x77,0x77,0x76,0x55,0x55,0x55,0x55,0x42,0x10,0x77,0x77,0x76,0x55,0x55,0x55,0x55,0x42,0x10,0x31,0x00,0x01,0xFF,0x00,0x40,0x8C,0x8C,0x40);///VOP=5.6V
    lcm_dcs_write_seq_static(ctx, 0x80,0xFF,0xF9,0xEE,0xE5,0xDE,0xD7,0xD2,0xCD,0xC8,0xBA,0xB1,0xA9,0xA2,0x9C,0x96,0x8A,0x81,0x78,0x70,0x6F,0x67,0x5F,0x57,0x4D,0x48,0x42,0x3B,0x33,0x2B,0x21,0x1E,0x1C);
    lcm_dcs_write_seq_static(ctx, 0x81,0xFF,0xF9,0xEE,0xE5,0xDE,0xD7,0xD2,0xCD,0xC8,0xBA,0xB1,0xA9,0xA2,0x9C,0x96,0x8A,0x81,0x78,0x70,0x6F,0x67,0x5F,0x57,0x4D,0x48,0x42,0x3B,0x33,0x2B,0x21,0x1E,0x1C);
    lcm_dcs_write_seq_static(ctx, 0x82,0xFF,0xF9,0xEE,0xE5,0xDE,0xD7,0xD2,0xCD,0xC8,0xBA,0xB1,0xA9,0xA2,0x9C,0x96,0x8A,0x81,0x78,0x70,0x6F,0x67,0x5F,0x57,0x4D,0x48,0x42,0x3B,0x33,0x2B,0x21,0x1E,0x1C);
    lcm_dcs_write_seq_static(ctx, 0x83,0x09,0x19,0x15,0x11,0x0C,0x04,0x00,0x19,0x15,0x11,0x0C,0x04,0x00,0x19,0x15,0x11,0x0C,0x04,0x00);
    lcm_dcs_write_seq_static(ctx, 0x84,0xC6,0x30,0xA6,0xE3,0x67,0xF2,0x15,0x18,0x28,0x80,0xC6,0x30,0xA6,0xE3,0x67,0xF2,0x15,0x18,0x28,0x80,0xC6,0x30,0xA6,0xE3,0x67,0xF2,0x15,0x18,0x28,0x80);
    ...
    lcm_dcs_write_seq_static(ctx, 0xD5,0x01,0xA3,0x00);
...
static int lcm_unprepare(struct drm_panel *panel)
{
    ...
    if (gs_smart_wakeup_flag_get()) {
        ...
        /*HS07 code for SR-AL7761A-01-227 by guyuming at 20250321 start*/
        mdelay(50);
        /*HS07 code for SR-AL7761A-01-227 by guyuming at 20250321 end*/
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_info("%s+ lcm,nl9916x_ld_hkc\n", __func__);

    if (lcm_detect_panel("nl9916x_ld_hkc")) {
        pr_err("%s- lcm,nl9916x_ld_hkc\n", __func__);
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_nl9916x_ld_hkc_mipi_hd_video",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("lcm nl9916x  ld hkc Panel Driver");
