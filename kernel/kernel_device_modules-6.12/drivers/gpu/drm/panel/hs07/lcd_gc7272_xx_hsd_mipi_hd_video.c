...
#define HAC (720)
/*HS07 code for HS07-1376 by huangyin at 20250423 start*/
#define HFP (128)
#define HSA (14)
#define HBP (124)
/*HS07 code for HS07-1376 by huangyin at 20250423 end*/
#define VAC (1600)
#define VFP (1224)
#define VFP_90 (272)
#define VSA (8)
...
#define FPS_60  60
#define FPS_90  90
/*HS07 code for HS07-802 by huangyin at 20250507 start*/
#define CUSTOM_MIN_BRIGHTNESS  0x20
#define CUSTOM_MAX_BRIGHTNESS  0x30
#define CUSTOM_ADJ_BRIGHTNESS  0x18
/*HS07 code for HS07-802 by huangyin at 20250507 end*/
/*HS07 code for HS-24 by huangyin at 20250225 end*/
...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xA3,0x13);
    ...
    lcm_dcs_write_seq_static(ctx, 0xC4,0x62);
    ...
    lcm_dcs_write_seq_static(ctx, 0xCB,0x5c);
    lcm_dcs_write_seq_static(ctx, 0xCD,0x5c);
    ...
    lcm_dcs_write_seq_static(ctx, 0xFF,0x28);
    lcm_dcs_write_seq_static(ctx, 0x3D,0x6b);
    lcm_dcs_write_seq_static(ctx, 0x3E,0x6b);
    ...
    lcm_dcs_write_seq_static(ctx,0x01,0x00,0x22,0x00,0x37,0x00,0x4f,0x00,0x6c,0x00,0x84,0x00,0x9a,0x00,0xaa,0x00,0xbb);
    lcm_dcs_write_seq_static(ctx,0x02,0x00,0xCa,0x00,0xFa,0x01,0x18,0x01,0x48,0x01,0x6F,0x01,0xA5,0x01,0xD2,0x01,0xD5);
    lcm_dcs_write_seq_static(ctx,0x03,0x02,0x08,0x02,0x49,0x02,0x75,0x02,0xB2,0x02,0xD9,0x03,0x0E,0x03,0x20,0x03,0x35);
    lcm_dcs_write_seq_static(ctx,0x04,0x03,0x49,0x03,0x61,0x03,0x7B,0x03,0xA0,0x03,0xD2,0x03,0xFF);
    lcm_dcs_write_seq_static(ctx,0x0D,0x00,0x22,0x00,0x37,0x00,0x4f,0x00,0x6c,0x00,0x84,0x00,0x9a,0x00,0xaa,0x00,0xbb);
    lcm_dcs_write_seq_static(ctx,0x0E,0x00,0xCa,0x00,0xFa,0x01,0x18,0x01,0x48,0x01,0x6F,0x01,0xA5,0x01,0xD2,0x01,0xD5);
    lcm_dcs_write_seq_static(ctx,0x0F,0x02,0x08,0x02,0x49,0x02,0x75,0x02,0xB2,0x02,0xD9,0x03,0x0E,0x03,0x20,0x03,0x35);
    lcm_dcs_write_seq_static(ctx,0x10,0x03,0x49,0x03,0x61,0x03,0x7B,0x03,0xA0,0x03,0xD2,0x03,0xFF);
...
MODULE_DESCRIPTION("lcm gc7272 xx hsd Panel Driver");
