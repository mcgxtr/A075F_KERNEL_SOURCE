...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_info("%s+ lcm,nl9916x_txd_boe_hh\n", __func__);
    /*HS07 code for HS07-4936 by guyuming at 20250707 start*/
    if (lcm_detect_panel("lcd_nl9916x_txd_boe_hh_mipi_hd_video")) {
        pr_err("%s- lcm,nl9916x_txd_boe_hh\n", __func__);
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_nl9916x_txd_boe_hh_mipi_hd_video",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("lcm nl9916x  txd boe hh Panel Driver");
