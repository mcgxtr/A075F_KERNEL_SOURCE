...
/*A07 LTE_BOS code for AL7761C-1 by jiangyue at 20250808 start*/
#define BACKLIGHT_MAX_REG_VAL   20
#define BACKLIGHT_MAX_APP_VAL   23
/*A07 LTE_BOS code for AL7761C-1 by jiangyue at 20250808 end*/
...
#define FPS_60  60
#define FPS_90  90
#define CUSTOM_MIN_BRIGHTNESS  0x20
#define CUSTOM_MAX_BRIGHTNESS  0x30
#define CUSTOM_ADJ_BRIGHTNESS  0x18
...
static void lcm_panel_init(struct lcm *ctx)
{
    //V03 Change gamma
    lcm_dcs_write_seq_static(ctx, 0xF0,0x99,0x16,0x18);
    lcm_dcs_write_seq_static(ctx, 0xB2,0x95,0x96,0x05,0x04,0x44,0x44,0x0F,0x83,0x88,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x00,0x00,0x55,0x55,0x00,0x00,0x00);
    lcm_dcs_write_seq_static(ctx, 0xB3,0xF7,0x49,0x09,0x78,0x0B,0x6A,0x0A);
    lcm_dcs_write_seq_static(ctx, 0xB4,0x10,0x18,0x0A,0x18,0x0A,0xC6,0x26,0x01,0xA2,0x33,0x44,0x00,0x26,0x00);

    //FORWARD
    lcm_dcs_write_seq_static(ctx, 0xB5,0x82,0x00,0xBB,0x18,0x1A,0x1C,0x1E,0x10,0x12,0x14,0x16,0x3A,0x04,0x08,0x82,0x82,0x82,0x82,0x82,0x82,0x82,0x82,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFC);
    lcm_dcs_write_seq_static(ctx, 0xB6,0x82,0x00,0xBB,0x19,0x1B,0x1D,0x1F,0x11,0x13,0x15,0x17,0x3A,0x05,0x09,0x82,0x82,0x82,0x82,0x82,0x82,0x82,0x82,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFC);
    ...
    lcm_dcs_write_seq_static(ctx, 0xC5,0x00,0x0D,0x18,0x00,0xFF,0x08,0xF0,0x20,0x20,0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0x80,0xFF,0xF7,0xEB,0xE1,0xDA,0xD3,0xCD,0xC8,0xC3,0xB6,0xAC,0xA5,0x9E,0x97,0x90,0x85,0x7B,0x73,0x6B,0x6A,0x62,0x5A,0x52,0x49,0x43,0x3E,0x37,0x2F,0x27,0x1E,0x1C,0x19);
    lcm_dcs_write_seq_static(ctx, 0x81,0xFF,0xF7,0xEB,0xE1,0xDA,0xD3,0xCD,0xC8,0xC3,0xB6,0xAC,0xA5,0x9E,0x97,0x90,0x85,0x7B,0x73,0x6B,0x6A,0x62,0x5A,0x52,0x49,0x43,0x3E,0x37,0x2F,0x27,0x1E,0x1C,0x19);
    lcm_dcs_write_seq_static(ctx, 0x82,0xFF,0xF7,0xEB,0xE1,0xDA,0xD3,0xCD,0xC8,0xC3,0xB6,0xAC,0xA5,0x9E,0x97,0x90,0x85,0x7B,0x73,0x6B,0x6A,0x62,0x5A,0x52,0x49,0x43,0x3E,0x37,0x2F,0x27,0x1E,0x1C,0x19);
    lcm_dcs_write_seq_static(ctx, 0x83,0x09,0x16,0x12,0x0E,0x09,0x02,0x00,0x16,0x12,0x0E,0x09,0x02,0x00,0x16,0x12,0x0E,0x09,0x02,0x00);
    lcm_dcs_write_seq_static(ctx, 0x84,0xF7,0x19,0x9C,0x0E,0x82,0xB4,0xC7,0xF1,0x78,0x00,0xF7,0x19,0x9C,0x0E,0x82,0xB4,0xC7,0xF1,0x78,0x00,0xF7,0x19,0x9C,0x0E,0x82,0xB4,0xC7,0xF1,0x78,0x00);
    ...
    lcm_dcs_write_seq_static(ctx, 0xE5,0x8C,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x0B,0x13,0x97,0x00,0xB0,0x00,0x07);
                 ...
                 unsigned int level)
{
    ...
    if (level >= CUSTOM_MIN_BRIGHTNESS && level <= CUSTOM_MAX_BRIGHTNESS) {
        level = CUSTOM_ADJ_BRIGHTNESS;
    }
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
    ...
    pr_info("%s+ lcm,nl9916x_txd_boe_htr\n", __func__);

    if (lcm_detect_panel("lcd_nl9916x_txd_boe_htr_mipi_hd_video")) {
        pr_err("%s- lcm,nl9916x_txd_boe_htr\n", __func__);
        return -ENODEV;
    }
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "lcd_nl9916x_txd_boe_htr_mipi_hd_video",
        .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("lcm nl9916x  txd boe htr Panel Driver");
