...
static int virt_thermal_get_front_temp(struct thermal_zone_device *data, int *temp)
{
...
/*Tab A9 code for SR-AX6739A-01-523 by xiaozhenting at 20250618 start*/
static const struct thermal_zone_device_ops virt_front_thermal_ops = {
    .get_temp = virt_thermal_get_front_temp,
};
/*Tab A9 code for SR-AX6739A-01-523 by xiaozhenting at 20250618 end*/
static int virt_front_thermal_probe(struct platform_device *pdev)
{
    ...
    /*Tab A9 code for SR-AX6739A-01-523 by xiaozhenting at 20250618 start*/
    bti->tz_dev = devm_thermal_of_zone_register(&pdev->dev, 0, bti,
...
/*Tab A9 code for SR-AX6739A-01-523 by xiaozhenting at 20250618 start*/
static void gxy_front_temp_remove(struct platform_device *pdev)
{
