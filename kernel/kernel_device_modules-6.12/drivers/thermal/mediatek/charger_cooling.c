...
/*HS07 code for HS07-186|HS07-1226 by yexuedong at 20250421 start*/
#if IS_ENABLED(CONFIG_CUSTOM_PROJECT_HS07)
static const int master_charger_state_to_current_limit[CHARGER_STATE_NUM] = {
	-1, 2600000, 2000000, 1800000, 1400000, 700000, 600000, 500000, 0
};
/* HST11 code for AX7800A-494 by wenyaqi at 20250424 start */
#elif IS_ENABLED(CONFIG_CUSTOM_PROJECT_HST11)
static const int master_charger_state_to_current_limit[CHARGER_STATE_NUM] = {
	-1, 2600000, 2300000, 1800000, 1500000, 1000000, 700000, 500000, 0
};
...
#endif
/*HS07 code for HS07-186|HS07-1226 by yexuedong at 20250421 end*/
