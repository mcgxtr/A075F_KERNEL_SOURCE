...
#define AF_DRVNAME "A1101CN3927AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long A1101CN3927AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int A1101CN3927AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int A1101CN3927AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int A1101CN3927AF_GetFileName(unsigned char *pFileName)
{
