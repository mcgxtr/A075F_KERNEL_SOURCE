...
/* Tab A07 code for AL7761C-3 by hanxiao at 202450730 start */
#ifdef CONFIG_CUSTOM_PROJECT_HS07
#define A0701GT9778AF_SetI2Cclient A0701GT9778AF_SetI2Cclient_Main
#define A0701GT9778AF_Ioctl A0701GT9778AF_Ioctl_Main
#define A0701GT9778AF_Release A0701GT9778AF_Release_Main
#define A0701GT9778AF_GetFileName A0701GT9778AF_GetFileName_Main
extern int A0701GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0701GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0701GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0701GT9778AF_GetFileName(unsigned char *pFileName);
#define A0702PD9402AF_SetI2Cclient A0702PD9402AF_SetI2Cclient_Main
#define A0702PD9402AF_Ioctl A0702PD9402AF_Ioctl_Main
#define A0702PD9402AF_Release A0702PD9402AF_Release_Main
#define A0702PD9402AF_GetFileName A0702PD9402AF_GetFileName_Main
extern int A0702PD9402AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0702PD9402AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0702PD9402AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0702PD9402AF_GetFileName(unsigned char *pFileName);
#define A0703PD9402AF_SetI2Cclient A0703PD9402AF_SetI2Cclient_Main
#define A0703PD9402AF_Ioctl A0703PD9402AF_Ioctl_Main
#define A0703PD9402AF_Release A0703PD9402AF_Release_Main
#define A0703PD9402AF_GetFileName A0703PD9402AF_GetFileName_Main
extern int A0703PD9402AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0703PD9402AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0703PD9402AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0703PD9402AF_GetFileName(unsigned char *pFileName);
#define A0704GT9778AF_SetI2Cclient A0704GT9778AF_SetI2Cclient_Main
#define A0704GT9778AF_Ioctl A0704GT9778AF_Ioctl_Main
#define A0704GT9778AF_Release A0704GT9778AF_Release_Main
#define A0704GT9778AF_GetFileName A0704GT9778AF_GetFileName_Main
extern int A0704GT9778AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0704GT9778AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0704GT9778AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0704GT9778AF_GetFileName(unsigned char *pFileName);
#define A0705CN3968AF_SetI2Cclient A0705CN3968AF_SetI2Cclient_Main
#define A0705CN3968AF_Ioctl A0705CN3968AF_Ioctl_Main
#define A0705CN3968AF_Release A0705CN3968AF_Release_Main
#define A0705CN3968AF_GetFileName A0705CN3968AF_GetFileName_Main
extern int A0705CN3968AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A0705CN3968AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A0705CN3968AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A0705CN3968AF_GetFileName(unsigned char *pFileName);
#endif
/* Tab A07 code for AL7761C-3 by hanxiao at 202450730 end */
...
extern int AW8601XAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
//Tab A9 code for SR-AX6739A-01-212 by rongyi at 20230509 end
/* HST11  code  for AX7800A-151 by liugang at 20250512 start */

#define A1101CN3927AF_SetI2Cclient A1101CN3927AF_SetI2Cclient_Main
#define A1101CN3927AF_Ioctl A1101CN3927AF_Ioctl_Main
#define A1101CN3927AF_Release A1101CN3927AF_Release_Main
#define A1101CN3927AF_GetFileName A1101CN3927AF_GetFileName_Main
extern int A1101CN3927AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A1101CN3927AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			unsigned long a_u4Param);
extern int A1101CN3927AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A1101CN3927AF_GetFileName(unsigned char *pFileName);
/* HST11  code  for AX7800A-151 by liugang at 20250512 end */
/* HST11  code  for AX7800A-160 by lidong at 20250512 start */
#define A1102CN3927AF_SetI2Cclient A1102CN3927AF_SetI2Cclient_Main
#define A1102CN3927AF_Ioctl A1102CN3927AF_Ioctl_Main
#define A1102CN3927AF_Release A1102CN3927AF_Release_Main
#define A1102CN3927AF_PowerDown A1102CN3927AF_PowerDown_Main
#define A1102CN3927AF_GetFileName A1102CN3927AF_GetFileName_Main
extern int A1102CN3927AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				   spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A1102CN3927AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			     unsigned long a_u4Param);
extern int A1102CN3927AF_Release(struct inode *a_pstInode,
			       struct file *a_pstFile);
extern int A1102CN3927AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int A1102CN3927AF_GetFileName(unsigned char *pFileName);
/* HST11  code  for AX7800A-160 by lidong at 20250512 end */
/* HST11  code  for AX7800A-158 by lixiaoqi at 20250513 start */
#define A1103PD9215BL_SetI2Cclient A1103PD9215BL_SetI2Cclient_Main
#define A1103PD9215BL_Ioctl A1103PD9215BL_Ioctl_Main
#define A1103PD9215BL_Release A1103PD9215BL_Release_Main
#define A1103PD9215BL_GetFileName A1103PD9215BL_GetFileName_Main
extern int A1103PD9215BL_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long A1103PD9215BL_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int A1103PD9215BL_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int A1103PD9215BL_GetFileName(unsigned char *pFileName);
/* HST11  code  for AX7800A-158 by lixiaoqi at 20250513 end*/
