...
#include "a07yywxdepthsc201cs_mipi_raw.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "A07YYWXDEPTHSC201CS_MIPI_RAW_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = { 
    .sensor_id = A07YYWXDEPTHSC201CS_SENSOR_ID,
...
UINT32 A07YYWXDEPTHSC201CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
