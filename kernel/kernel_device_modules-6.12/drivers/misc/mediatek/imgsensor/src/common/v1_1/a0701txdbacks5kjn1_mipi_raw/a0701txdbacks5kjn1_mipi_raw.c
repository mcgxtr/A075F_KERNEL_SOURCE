...
#include "a0701txdbacks5kjn1_mipi_raw.h"

/*hs14 code for AL6528ADEU-2675 by liluling at 2022-11-22 start*/
/* HS07 V code for SR-AL7761A-01-416 by liugang at 2025/03/31 start */
#define FPTPDAFSUPPORT 1
/* HS07 V code for SR-AL7761A-01-416 by liugang at 2025/03/31 end */
#define MULTI_WRITE 1
#define OTP_DATA_NUMBER 9

#define PFX "A0701TXDBACKS5KJN1_MIPI_RAW_camera_sensor"
/* A06 code for SR-AL7160A-01-502 by hanhaoran at 20240424 start */
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)
static DEFINE_SPINLOCK(imgsensor_drv_lock);
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = A0701TXDBACKS5KJN1_SENSOR_ID ,
	...
	/* HS07 V code for HS07-2741  by yuzifei at 2025/06/09 start */
	.margin = 8,
	/* HS07 V code for HS07-2741  by yuzifei at 2025/06/09 end */
	.min_shutter = 5,
...
/* HS07 V code for SR-AL7761A-01-418  by huabinchen at 2025/04/18 start */
	.frame_time_delay_frame = 2,
/* HS07 V code for SR-AL7761A-01-418  by huabinchen at 2025/04/18 end */
	.ihdr_support = 0,
	.ihdr_le_firstline = 0,
...
static void read_sensor_chip_id(UINT32 *sensor_id)
{
	if (S5KJN1_eeprom[SENSOR_SN_OFFSET-1] == 0x01)
	{
	    ...
	    for (i = 0; i < SENSOR_SN_SIZE; i++)
	    {
			...
			pr_err("[cameradebug-chipid]S5KJN1_CHIP_ID[%zu]=0x%x",i,S5KJN1_CHIP_ID[i]);
	    }
...
extern int hbb_flag;
#define S5KJN1_EEPROM_VENDORID1 0x51
#define S5KJN1_EEPROM_VENDORID2 0x53
#define S5KJN1_EEPROM_VENDORID3 0x61
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if(s5kjn1VendorId != 0xff && s5kjn1VendorId != S5KJN1_EEPROM_VENDORID1&& s5kjn1VendorId != S5KJN1_EEPROM_VENDORID2 && s5kjn1VendorId != S5KJN1_EEPROM_VENDORID3)
                {
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_MIN_SHUTTER_BY_SCENARIO:
		...
		*(feature_data + 2) = imgsensor_info.exp_step;
		break;
/* HS07 V code for HS07-2789 by huabinchen at 2025/05/19 start */
	case SENSOR_FEATURE_GET_BINNING_TYPE:
		switch (*(feature_data + 1)) {
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
			*feature_return_para_32 = 3800; /*BINNING_AVERAGED*/
			break;
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG: 
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
...
/* HS07 V code for HS07-2789 by huabinchen at 2025/05/19 end */
		LOG_INF(
...
/* HS07 V code for SR-AL7761A-01-373  by zhongbin at 2025/04/07 start */
	...
	{
		pr_err("[cameradebug-sninfo E");
        read_sensor_chip_id(feature_return_para_32);
		pr_err("[cameradebug-sninfo X");
		break;
	}
/* HS07 V code for SR-AL7761A-01-373  by zhongbin at 2025/04/07 end */
#endif
...
UINT32
A0701TXDBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("A0701TXDBACKS5KJN1_MIPI_RAW_SensorInit in  fufu\n");
