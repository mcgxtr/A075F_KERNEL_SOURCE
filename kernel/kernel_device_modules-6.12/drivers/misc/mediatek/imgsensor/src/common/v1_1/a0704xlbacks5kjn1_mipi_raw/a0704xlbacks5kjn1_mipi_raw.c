...
#include "a0704xlbacks5kjn1_mipi_raw.h"
...
extern int hbb_flag;
#define S5KJN1_EEPROM_VENDORID2 0x52
#define S5KJN1_EEPROM_VENDORID4 0x54
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if(s5kjn1VendorId != 0xff && s5kjn1VendorId != S5KJN1_EEPROM_VENDORID2 && s5kjn1VendorId != S5KJN1_EEPROM_VENDORID4)
                {
...
UINT32
A0704XLBACKS5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("A0704XLBACKS5KJN1_MIPI_RAW_SensorInit in  fufu\n");
