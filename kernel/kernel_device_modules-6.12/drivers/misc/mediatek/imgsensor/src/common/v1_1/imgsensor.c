...
/* A07 LTE code for AL7761C-3 by hanxiao at 202450804 start */
#ifdef CONFIG_CUSTOM_PROJECT_HS07
extern char hq_camerachipSN[255];
extern char *hq_cameraSNModuleInfo[3];
#endif
/* A07 LTE code for AL7761C-3 by hanxiao at 202450804 end */
...
/* A07 LTE code for AL7761C-3 by hanxiao at 202450804 start */
    ...
    {
		pr_info("[A07 read SN psensor_inst->psensor_list->name]=%s",psensor_inst->psensor_list->name);
        if ((!strcmp(psensor_inst->psensor_list->name,"a0701txdbacks5kjn1_mipi_raw")) ||
            (!strcmp(psensor_inst->psensor_list->name,"a0702txdbackgc50e1_mipi_raw")) ||
            (!strcmp(psensor_inst->psensor_list->name,"a0703xlbackgc50e1_mipi_raw")) ||
            (!strcmp(psensor_inst->psensor_list->name,"a0704xlbacks5kjn1_mipi_raw")) ||
            (!strcmp(psensor_inst->psensor_list->name,"a0705lybackgc50e1_mipi_raw")))
        {
            hq_cameraSNModuleInfo[0] = psensor_inst->psensor_list->name;
            ...
            , hq_cameraSN[11], hq_cameraSN[12], hq_cameraSN[13], hq_cameraSN[14]);
                pr_err("[A07 read SN number]=%s",hq_camerachipSN);
            }
        }
    }
    #endif
...
#define _DATA_SIZE 64
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:
		{
/* HS07 B code for AL7761C-127 by jiangwenhan at 2025/08/07 start */
#if defined(CONFIG_CUSTOM_PROJECT_HS07)
#define PDAF_DATA_SIZE 9600
#else
#define PDAF_DATA_SIZE 4096
#endif
/* HS07 B code for AL7761C-127 by jiangwenhan at 2025/08/07 end */
