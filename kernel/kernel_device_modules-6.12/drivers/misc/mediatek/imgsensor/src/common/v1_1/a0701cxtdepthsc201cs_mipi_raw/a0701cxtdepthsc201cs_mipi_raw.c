...
#include "a0701cxtdepthsc201cs_mipi_raw.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "A0701CXTDEPTHSC201CS_MIPI_RAW_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = { 
    .sensor_id = A0701CXTDEPTHSC201CS_SENSOR_ID,
...
{ 1600, 1200,     0,  150, 1600,  900, 1600,  900,   0,   0, 1600,  900,    0,	0, 1600,  900},  //hight speed video
{ 1600, 1200,     0,  150, 1600,  900, 1600,  900,   0,   0, 1600,  900,    0,	0, 1600,  900}, // slim video
...
{
LOG_INF("E!preview_setting 1600*1200 30fps\n"); 
//1600*1200
write_cmos_sensor(0x0103,0x01);
write_cmos_sensor(0x36e9,0x80);
write_cmos_sensor(0x36e9,0x24);
...
{
	LOG_INF("E!normal_video_setting 1600*1200 24fps\n"); 
//1600*1200,24fps
write_cmos_sensor(0x0103,0x01);
write_cmos_sensor(0x36e9,0x80);
write_cmos_sensor(0x36e9,0x24);
...
{
	LOG_INF("E!hs_video_setting 1600*900 30fps\n"); 
//1600*900 30fps
write_cmos_sensor(0x0103,0x01);
write_cmos_sensor(0x36e9,0x80);
write_cmos_sensor(0x36e9,0x24);
...
{
	LOG_INF("E!slim_video_setting 1600*900 24fps\n"); 
//1600*900
write_cmos_sensor(0x0103,0x01);
write_cmos_sensor(0x36e9,0x80);
write_cmos_sensor(0x36e9,0x24);
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
//1600*1200
	LOG_INF("E!custom1_setting custom1_setting 24fps\n");
...
UINT32 A0701CXTDEPTHSC201CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
