...
/*Tab A9 code for  AX6739A-2695 by pengxutao at 20230824 start */
...
static void set_shutter(kal_uint16 shutter)
{
    ...
    printk("C8490 set_shutter():ratio=%hu\n",ratio);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x300b,0x02); //y offset
...
/*Tab A9 code for  AX6739A-2695 by pengxutao at 20230824 end */
