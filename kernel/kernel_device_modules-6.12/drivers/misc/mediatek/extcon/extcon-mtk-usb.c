...
#if IS_ENABLED(CONFIG_CUSTOM_PROJECT_OT11)
		...
		unsigned long event, void *data)
{
	...
	/*HS07 code for HS07-752 by yexuedong at 20250417 start*/
	...
	/*HS07 code for HS07-752 by yexuedong at 20250417 end*/
