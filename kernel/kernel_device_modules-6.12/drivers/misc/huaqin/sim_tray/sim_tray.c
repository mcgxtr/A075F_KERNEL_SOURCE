...
static const struct proc_ops sim_tray_ops = {
...
static int det_pin_probe(struct platform_device *pdev)
{
	...
	ret = proc_create("hot-status", 0444, ret, &sim_tray_ops);
...
/*Tab A9_BOS code for AX6739W-50 by Liushiyuan at 20250619 start*/
static void det_pin_remove(struct platform_device *pdev)
{
