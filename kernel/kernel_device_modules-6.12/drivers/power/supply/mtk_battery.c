...
/*Tab A9 code for fix d85 build error by huanghe at 20250701 start*/
	gm->tbat_precise = 25;
/*Tab A9 code for fix d85 build error by huanghe at 20250701 end*/
	return 25;
#endif
...
/*Tab A9 code for AX6739W-26 by xiaojian at 20250620 start*/
#if defined(CONFIG_CUSTOM_PROJECT_OT11) || defined(CONFIG_CUSTOM_PROJECT_HS07) || defined(CONFIG_CUSTOM_PROJECT_HST11)
	else {
		gm->battery_id = battery_get_profile_id();
		bm_err(gm, "[%s] bat_id = %d\n",__func__, gm->battery_id);
	}
#endif
/*Tab A9 code for AX6739W-26 by xiaojian at 20250620 end*/
