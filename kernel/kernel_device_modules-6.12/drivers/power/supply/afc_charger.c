...
/*Tab A9 code for AX6739W-47 by wangmingye at 20250722 start*/
#include <linux/sec_ext.h>
/*Tab A9 code for AX6739W-47 by wangmingye at 20250722 end*/
...
static int afc_plugout_reset(struct chg_alg_device *alg)
{
    ...
    int cnt = 0;
    /*Tab A9 code for AX6739A-409 by wenyaqi at 20230530 end*/
    /*Tab A9 code for P250122-04729 by shanxinkai at 20250225 start*/
    int cnt_max = 5;
    /*Tab A9 code for P250122-04729 by shanxinkai at 20250225 end*/
    struct afc_charger *afc = NULL;
    ...
    if (afc->state != AFC_RUN &&
        ...
        /*HS07 code for HS07-53 by xiongxiaoliang at 20250304 start*/
        send_afc_result(AFC_INIT);
        /*HS07 code for HS07-53 by xiongxiaoliang at 20250304 end*/
...
/*Tab A9 code for SR-AX6739A-01-511 by wenyaqi at 20230523 end*/
    ...
    /*Tab A9 code add for P250219-03701 by shanxinkai at 20250225 start*/
    mutex_init(&afc->cable_out_lock);
    /*Tab A9 code add for P250219-03701 by shanxinkai at 20250225 end*/
...
static void afc_charger_remove(struct platform_device *dev)
{
    return ;
}
