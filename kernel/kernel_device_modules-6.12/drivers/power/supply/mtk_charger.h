...
/*HS07 code for HS07-236 by huofudong at 20250331 start*/
#if defined(CONFIG_ODM_CUSTOM_FACTORY_BUILD)
	/* HST11 code for AX7800A-496 by wenyaqi at 20250421 start */
	#if defined(CONFIG_CUSTOM_PROJECT_HS07) || defined(CONFIG_CUSTOM_PROJECT_HST11)
	/* HST11 code for AX7800A-496 by wenyaqi at 20250421 end */
	    #define BATT_CAP_CONTROL_CAPACITY 70
	#else
	    #define BATT_CAP_CONTROL_CAPACITY 80
	#endif
#endif //CONFIG_ODM_CUSTOM_FACTORY_BUILD
/*HS07 code for HS07-236 by huofudong at 20250331 end*/
...
/*HS07 code for SR-AL7761A-01-154|HS07-186|HS07-1226 by yexuedong at 20250507 start*/
...
#define AP_TEMP_T3_LCMON_CP_CC  2000000
...
#endif
#endif
/*HS07 code for SR-AL7761A-01-154|HS07-186|HS07-1226 by yexuedong at 20250507 end*/
...
struct charger_custom_data {
	...
	/* HST11 code for AX7800A-494 by wenyaqi at 20250424 start */
	/* sw thermal */
	unsigned int thermal_lcd_on_buck_cur[MAX_THERMAL_CUR_SIZE];
	unsigned int thermal_lcd_off_buck_cur[MAX_THERMAL_CUR_SIZE];
	int thermal_buck_cur_size;
	/* HST11 code for AX7800A-494 by wenyaqi at 20250424 end */
...
struct mtk_charger {
	...
	/* HST11 code for AX7800A-494 by wenyaqi at 20250424 start */
	/* custom thermal */
	bool enable_custom_thermal_buck;
	/* HST11 code for AX7800A-494 by wenyaqi at 20250424 end */
	/* HST11 code for AX7800A-494 by wenyaqi at 20250424 end */
