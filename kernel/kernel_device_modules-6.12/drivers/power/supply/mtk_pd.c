...
#define PD_VBUS_IR_DROP_THRESHOLD 1400
#else
			...
			int *newidx)
{
	...
	/*HS07 code for HS07-10 by xiongxiaoliang at 20250221 start*/
	#if (!defined(CONFIG_CUSTOM_PROJECT_OT11) && !defined(CONFIG_CUSTOM_PROJECT_HST11) && !defined(CONFIG_CUSTOM_PROJECT_HS07)) || defined(FIXME)
	/*HS07 code for HS07-10 by xiongxiaoliang at 20250221 end*/
	int ret = 0;
	#endif
	...
	if (cap->max_mv[idx] > PD_VOLTAGE_THR &&
		...
		*newidx = selected_idx;
		boost = false;
		buck = false;
	/* HST11 code for AX7800A-1091 by wenyaqi at 20250529 start */
	...
	/* HST11 code for AX7800A-1091 by wenyaqi at 20250529 end */
#endif
...
static int pd_sc_set_charger(struct chg_alg_device *alg)
{
	...
	if (pd->charging_current_limit1 != -1) {
		...
		/*HS07 code for HS07-162 by xiongxiaoliang at 20250307 start*/
		#if defined(CONFIG_CUSTOM_PROJECT_HS07)
		else {
			pd->charging_current1 = pd->sc_charger_current;
		}
		#endif
		/*HS07 code for HS07-162 by xiongxiaoliang at 20250307 end*/
...
/*Tab A9 code for AX6739W-26 by xiaojian at 20250626 start*/
		pd->enable_inductor_protect = val;
/*Tab A9 code for AX6739W-26 by xiaojian at 20250626 end*/
