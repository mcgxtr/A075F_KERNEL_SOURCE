...
mtk_kleaf_device_modules_kconfigs = [
    ...
    "//kernel_device_modules-{}/drivers/power/supply/charge_pump:ddk_kconfigs".format(kernel_version),
    # A07 code for AL7761C-1 by xiaojian at 20250729 end
    # Tab A11 code for AX7800W-11 by xiaozhenting at 20250820 start
    "//kernel_device_modules-{}/drivers/power/supply/battery/battery_auth/sle956681:ddk_kconfigs".format(kernel_version),
    # Tab A11 for AX7800W-11 by xiaozhenting at 20250820 end
...
mtk_kleaf_device_modules = [
    ...
    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-bias-ot11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_xx_inx_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_nl9951_gx_boe_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_lc_hkc_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_jd9366tc_xx_hkc_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_nt36523d_lc_hsd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_cd_inx_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_gx_hsd_incell_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_cd_inx_new_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_default_mipi_fhd_video".format(kernel_version),

    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-bias-hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_hx83108d_xx_hkc_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_boe_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_ld_hkc_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_gc7272_xx_hsd_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_xx_tm_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_csot_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_boe_hh_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_boe_htr_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_gc7272_xx_boe_mipi_hd_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_default_mipi_hd_video".format(kernel_version),

    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-bias-hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_hx83102e_lc_hkc_video_hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_hx83102g_xy_inx_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_jd9366tc_xy_csot_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_jd9366tc_lx_hkc_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_jd9366tc_ld_hkc_video".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_default_mipi_fhd_video_hst11".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/chipone:chipone".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/novatek:novatek".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/touch_common:touch_common".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hst11/hxchipset:hxchipset_hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hst11/jdchipset:jdchipset".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hst11/touch_common:touch_common_hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/chipone:chipone_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/galaxycore:galaxycore".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/hxchipset:hxchipset_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/touch_common:touch_common_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-s6e8fc3-s2dos15a01-vdo".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07:fingerprint_sysfs_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07/goodix:goodix_fp_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07/jiiov:jiiov_fp_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07/silead:silead_fingerprint_hs07".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/input/touchscreen/ZT7650M:zt7650m".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/misc/mediatek/typec/tcpc:aw35615_whole".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/mediatek/typec/tcpc:tcpc_cps8851".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/mediatek/typec/tcpc:tcpc_upm6922p".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/mediatek/typec/tcpc:tcpc_scv89601p_pd".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:battery_id_adc".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/misc/mediatek/typec/tcpc:tcpc_et7304".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/misc/huaqin/sim_tray:sim_tray".format(kernel_version),
    # Tab A9 code for AX6739W-30 by qiutong at 20250630 start
    "//kernel_device_modules-{}/drivers/misc/huaqin/combine_key:combine_key_trigger".format(kernel_version),
    # Tab A9 code for AX6739W-30 by qiutong at 20250630 end
    "//kernel_device_modules-{}/drivers/misc/huaqin/hperf:hperf".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/power/supply:gpio_afc".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:gxy_vbus_ctrl".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:gxy_psy_sysfs".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:gxy_ibus_adc".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/power/supply:sc89601d_charger".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:upm6910x_charger".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:upm6922p_charger".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply:scv89601p_charger".format(kernel_version),
    "//kernel_device_modules-{}/drivers/power/supply/charge_pump:pd_policy_manager".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/thermal/mediatek:gxy_virtual_front_temp".format(kernel_version),
    "//kernel_device_modules-{}/drivers/thermal/mediatek:gxy_virtual_back_temp".format(kernel_version),
    ...
    "//kernel_device_modules-{}/sound/soc/codecs/analogpa:analog_pa".format(kernel_version),
    "//kernel_device_modules-{}/sound/soc/codecs/aw87xxx:snd-soc-aw87xxx".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/input/sar:sensor_fac_node".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/sar:sensor_user_node".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/sar:sensors_core".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/sar:sx933x".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hst11_sar:sensor_fac_node_hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hst11_sar:sensor_user_node_hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hst11_sar:sensors_core_hst11".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hst11_sar/sx9378:sx937x".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hst11_sar/hx9031as:hx9031as".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hs07_sar:sensor_fac_node_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hs07_sar:sensor_user_node_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hs07_sar:sensors_core_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hs07_sar/sx9378:sx937x_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/input/hs07_sar/hx9031as:hx9031as_hs07".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/mediatek/board_id:board_id_status".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/grdm:grdm".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/KnoxVault:KnoxVault2".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/KnoxVaultDev:KnoxVaultDev".format(kernel_version),
]
...
mgk_64_kleaf_platform_modules = {
  ...
  ## write vendor file by platform here
    ...
    "//kernel_device_modules-{}/drivers/misc/huaqin/sim_tray:sim_tray".format(kernel_version): "mt6789",
    # Tab A9 code for AX6739W-30 by qiutong at 20250630 start
    "//kernel_device_modules-{}/drivers/misc/huaqin/combine_key:combine_key_trigger".format(kernel_version): "mt6789",
    # Tab A9 code for AX6739W-30 by qiutong at 20250630 end
    ...
    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-bias-ot11".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_xx_inx_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_nl9951_gx_boe_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_lc_hkc_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_jd9366tc_xx_hkc_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_nt36523d_lc_hsd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_cd_inx_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_gx_hsd_incell_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_hx83102e_cd_inx_new_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/ot11:lcd_default_mipi_fhd_video".format(kernel_version): "mt6789",

    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-bias-hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_hx83108d_xx_hkc_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_boe_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_ld_hkc_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_gc7272_xx_hsd_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_xx_tm_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_csot_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_boe_hh_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_nl9916x_txd_boe_htr_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_gc7272_xx_boe_mipi_hd_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hs07:lcd_default_mipi_hd_video".format(kernel_version): "mt6789",

    "//kernel_device_modules-{}/drivers/gpu/drm/panel:panel-bias-hst11".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_hx83102e_lc_hkc_video_hst11".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_hx83102g_xy_inx_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_jd9366tc_xy_csot_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_jd9366tc_lx_hkc_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_jd9366tc_ld_hkc_video".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/gpu/drm/panel/hst11:lcd_default_mipi_fhd_video_hst11".format(kernel_version): "mt6789",

    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/hxchipset:hxchipset".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/chipone:chipone".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/novatek:novatek".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/jdchipset:jdchipset_ot11".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/ot11/touch_common:touch_common".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hst11/hxchipset:hxchipset_hst11".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hst11/jdchipset:jdchipset".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hst11/touch_common:touch_common_hst11".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/chipone:chipone_hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/galaxycore:galaxycore".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/hxchipset:hxchipset_hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/touchscreen/hs07/touch_common:touch_common_hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07:fingerprint_sysfs_hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07/goodix:goodix_fp_hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07/jiiov:jiiov_fp_hs07".format(kernel_version): "mt6789",
    "//kernel_device_modules-{}/drivers/input/fingerprint/hs07/silead:silead_fingerprint_hs07".format(kernel_version): "mt6789",
...
# Tab A9 code for AX6739W-59 by zhouruihao at 20250717 start
    if "ot11.config" in DEFCONFIG_OVERLAYS:
        mgk_64_common_userdebug_modules.append("drivers/spi/spidev.ko")
        mgk_64_common_eng_modules.append("drivers/spi/spidev.ko")
        mgk_64_common_user_modules.append("drivers/spi/spidev.ko")
# Tab A9 code for AX6739W-59 by zhouruihao at 20250717 end
    ...
    # HST11 code for AX7800W-11 by xiaozhenting at 20250722 start
    if "hst11.config" in DEFCONFIG_OVERLAYS:
        mgk_64_kleaf_device_modules.append("//kernel_device_modules-{}/drivers/power/supply/battery/battery_auth/sle956681:sec-auth-sle956681".format(kernel_version))
    # HST11 code for AX7800W-11 by xiaozhenting at 20250722 end

    # A07 code for AL7761C-1 by xiaojian at 20250722 start
    if "hs07.config" in DEFCONFIG_OVERLAYS:
        mgk_64_kleaf_modules.append("//kernel_device_modules-{}/drivers/power/supply/charge_pump:sp2131_charger".format(kernel_version))
    # A07 code for AL7761C-1 by xiaojian at 20250722 end
    # A07 code for AL7761C-1 by luojunming at 20250724 start
        mgk_64_kleaf_device_modules.append("//kernel_device_modules-{}/drivers/power/supply/charge_pump:nx853x_charger".format(kernel_version))
        mgk_64_kleaf_device_modules.append("//kernel_device_modules-{}/drivers/power/supply/charge_pump:sgm41608_charger".format(kernel_version))
        mgk_64_kleaf_device_modules.append("//kernel_device_modules-{}/drivers/power/supply/charge_pump:upm6726_charger".format(kernel_version))
    # A07 code for AL7761C-1 by luojunming at 20250724 end
    # A07 code for AL7761C-1 by wangtengfei at 20250728 start
