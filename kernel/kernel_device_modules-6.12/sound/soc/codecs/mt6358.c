...
/*Tab A11 code for AX7800W-11 by liaoku at 20250715 start*/
#if IS_ENABLED(CONFIG_SND_SOC_ANALOG_PA)
#include "analogpa/analog_pa.h"
#endif
/*Tab A11 code for AX7800W-11 by liaoku at 20250715 end*/
			 ...
			 int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		/*Tab A9 code for AX6739W-10 by liaoku at 20250606 start*/
		regmap_write(priv->regmap, MT6358_AFUNC_AUD_CON0, 0xcfa1);
		/*Tab A9 code for AX6739W-10 by liaoku at 20250606 end*/
		/* sdm power on */
...
static int mt6358_amic_enable(struct mt6358_priv *priv)
{
	...
	if (mux_pga_l == PGA_MUX_AIN1 || mux_pga_r == PGA_MUX_AIN1) {
		...
		if (mic_type == MIC_TYPE_MUX_DCC_ECM_SINGLE)
			...
			/*Tab A9 code for AX6739W-44 by liaoku at 20250611 start*/
			regmap_write(priv->regmap,
				     MT6358_AUDENC_ANA_CON10, 0x0071);
			/*Tab A9 code for AX6739W-44 by liaoku at 20250611 end*/
	}
...
/*Tab A11 code for AX7800W-11 by liaoku at 20250715 start*/
#if IS_ENABLED(CONFIG_SND_SOC_ANALOG_PA)
        ret = add_analog_pa_controls(cmpnt);
        if (ret < 0) {
                pr_err("%s: add_analog_pa_controls failed, err %d\n" , __func__ , ret);
                return ret;
        }
#endif
/*Tab A11 code for AX7800W-11 by liaoku at 20250715 end*/
